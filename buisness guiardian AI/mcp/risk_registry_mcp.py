...
def _is_valid_timestamp(ts_str: Any) -> bool:
    """Check if ts_str is a valid ISO 8601 UTC timestamp in format YYYY-MM-DDTHH:MM:SSZ."""
...
def fetch_risk_history(inputs: dict[str, Any]) -> dict[str, Any]:
    ...
    try:
        ...
        # Find latest business_risk record
