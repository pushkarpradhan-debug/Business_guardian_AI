...
|---|---|
| Inventory Agent | `mcp_data.inventory_data`, `mcp_data.sales_data`, `business_type` |
...
| Compliance Agent | `mcp_data.compliance_data`, `analysis_window_days`, `business_type` |
| Risk Tracker Agent | `agent_reports.inventory_report`, `agent_reports.finance_report`, `agent_reports.supplier_report`, `agent_reports.compliance_report`, `mcp_data.risk_history` |
| Strategy Agent | `agent_reports.business_risk_report`, `agent_reports.inventory_report`, `agent_reports.finance_report`, `agent_reports.supplier_report`, `agent_reports.compliance_report`, `business_type` |
...
| 4 | All four parallel agents completed with `status: "success"` | `agent_reports.inventory_report`, `finance_report`, `supplier_report`, `compliance_report` all non-null |
